...
@Mod.EventBusSubscriber(modid = CreateAutoCrafting.MODID, bus = Mod.EventBusSubscriber.Bus.FORGE)
public class ModEvents {
    ...
    public static void onServerTick(TickEvent.ServerTickEvent event) {
        ...
        if (++pollTicker >= 20) {
            ...
            if (server != null) {
                net.hihellohi.createautocrafting.manager.CraftJobManager.tick(server);
            }
        }
    }
    @SubscribeEvent
