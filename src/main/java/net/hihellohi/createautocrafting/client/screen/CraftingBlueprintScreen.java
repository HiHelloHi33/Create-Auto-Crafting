...
public class CraftingBlueprintScreen extends AbstractContainerScreen<CraftingBlueprintMenu> {
    ...
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath("createautocrafting", "textures/gui/crafting_blueprint.png");
    private static final ResourceLocation SWITCHES =
            ResourceLocation.fromNamespaceAndPath("createautocrafting", "textures/gui/switches.png");
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double scrollX, double scrollY) {
        ...
        if (hovered != null && hovered.hasItem()) {
            ...
            if (editable) {
                int newCount = Mth.clamp(hovered.getItem().getCount() + (scrollY > 0 ? 1 : -1), 1, 64);
